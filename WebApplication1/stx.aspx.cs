    ...
    public partial class stx : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            foreach (DataRow dri in objDataset1.Tables[0].Rows)
            {
                ...
                btindex = btindex + 1;
                //EventHandler myEvent = (sender, e) => julubutton_click(bt2.Text);//my delegate
                bt2.Click += (sender0,e0) => julubutton_click(dri[0].ToString(), bt2.Text);
                ...
                btindex = btindex + 1;
                bt3.Click += (sender0, e0) => julubutton_click(dri[0].ToString(), bt3.Text);
        ...
        protected void julubutton_click(string oid, string type)
        {
            string str = "<script>window.open('adddate.aspx?oid=" +
                oid + "&type=" + type +
                "','_blank')</script>";
            Response.Write(str);
